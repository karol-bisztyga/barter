...
const insertHardcodedUsers = async () => {
  const users = [
    ...
    },
    {
      ...
      phone: '987654321',
      facebook: 'iamtestuser2',
      instagram: 'testuser22',
      profilePicture: null,
...
const insertHardcodedItems = async () => {
  const hardcodedItems = [
    {
      userId: 1,
      name: 'Sample Item 1-1',
      description: 'Description for sample item 1-1',
    },
    {
      userId: 1,
      name: 'Sample Item 1-2',
      description: 'Description for sample item 1-2',
    },
    {
      userId: 1,
      name: 'Sample Item 1-3',
      description: 'Description for sample item 1-3',
    },
    {
      userId: 2,
      name: 'Sample Item 2-1',
      description: 'Description for sample item 2-1',
    },
    {
      userId: 2,
      name: 'Sample Item 2-2',
      description: 'Description for sample item 2-2',
    },
    {
      userId: 2,
      name: 'Sample Item 2-3',
      description: 'Description for sample item 2-3',
    },
    {
      userId: 3,
      name: 'Sample Item 3-1',
      description: 'Description for sample item 3-1',
    },
    {
      userId: 3,
      name: 'Sample Item 3-2',
      description: 'Description for sample item 3-2',
    },
    {
      userId: 3,
      name: 'Sample Item 3-3',
      description: 'Description for sample item 3-3',
    },
    {
      userId: 4,
      name: 'Sample Item 4-1',
      description: 'Description for sample item 4-1',
    },
    {
      userId: 4,
      name: 'Sample Item 4-2',
      description: 'Description for sample item 4-2',
    },
    {
      userId: 4,
      name: 'Sample Item 4-3',
      description: 'Description for sample item 4-3',
    },
    {
      userId: 5,
      name: 'Sample Item 5-1',
      description: 'Description for sample item 5-1',
    },
    {
      userId: 5,
      name: 'Sample Item 5-2',
      description: 'Description for sample item 5-2',
    },
    {
      userId: 5,
      name: 'Sample Item 5-3',
      description: 'Description for sample item 5-3',
    },
  ];
